...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-lg-12">
			<div class="col-md-4 input-group offset-4" style="float: right;">
					...
					<table width="100%"cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" style="margin-top: 12px;">
						<tr>
							<thead style="background-color: gray;">
								<th width="40%" class="" style="text-align: center; color:white;">Filename</th>
								<th width="20%" class=""style="text-align: center; color:white;">Date</th>
								<th width="40%" class=""style="text-align: center; color:white;">Description</th>
							</thead>
						</tr>
						<?php 
