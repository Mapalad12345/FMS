...
<div class="containe-fluid">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card col-md-4 offset-2 float-left" style="background-color: #15b7fb; border-radius: 30px;">
				<div class="card-body" style="color: #e1e4e5;">
					<h4><b>Users</b></h4>
					<hr>
			...
			<div class="card col-md-4 offset-2 ml-4 float-left" style="background-color: #5376f6;border-radius: 30px;">
				<div class="card-body "style="color: #e1e4e5;">
					<h4><b>Files</b></h4>
					<hr>
	...
	<div class="row mt-3 ml-3 mr-3">
			<div class="card col-md-12" style="border-width: 2px; border-color: lightgray;" >
				<div >
					<table width="100%"cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"style="margin-top: 12px;">
						<thead style="background-color: gray;">
							<tr>
								<th width="15%" class="" style="text-align: center; color:white;">Uploader</th>
								<th width="30%" class=""style="text-align: center;color:white;">Filename</th>
								<th width="20%" class=""style="text-align: center;color:white;">Date</th>
								<th width="35%" class=""style="text-align: center;color:white;">Description</th>
							</tr>
						</thead>
						<?php 
